...
#include "multicopter_mpc_rviz_plugins/WholeBodyTrajectoryDisplay.h"
#include "multicopter_mpc_rviz_plugins/PinocchioLinkUpdater.h"
#include <Eigen/Dense>
...
void WholeBodyTrajectoryDisplay::processMessage(const multicopter_mpc_msgs::WholeBodyTrajectory::ConstPtr &msg) {
  msg_ = msg;
  is_info_ = true;
  processTargetPosture();
  processCoMTrajectory();
...
PLUGINLIB_EXPORT_CLASS(multicopter_mpc_rviz_plugins::WholeBodyTrajectoryDisplay, rviz::Display)
