...
#include "multicopter_mpc_rviz_plugins/WholeBodyStateDisplay.h"
...
void WholeBodyStateDisplay::processMessage(const multicopter_mpc_msgs::WholeBodyState::ConstPtr &msg) {
  msg_ = msg;
  is_info_ = true;
  processWholeBodyState();
}
...
PLUGINLIB_EXPORT_CLASS(multicopter_mpc_rviz_plugins::WholeBodyStateDisplay, rviz::Display)
