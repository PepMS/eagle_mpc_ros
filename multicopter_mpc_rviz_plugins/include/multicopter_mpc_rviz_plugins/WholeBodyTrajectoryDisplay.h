...
#include "multicopter_mpc_rviz_plugins/ArrowVisual.h"
...
namespace multicopter_mpc_rviz_plugins {

/**
 * @class WholeBodyTrajectoryDisplay
 * @brief Displays a multicopter_mpc_msgs::WholeBodyTrajectory message
 */
class WholeBodyTrajectoryDisplay : public rviz::MessageFilterDisplay<multicopter_mpc_msgs::WholeBodyTrajectory> {
  Q_OBJECT
 public:
   ...
   * @param const multicopter_mpc_msgs::WholeBodyTrajectory::ConstPtr& Whole-body state msg
   */
  void processMessage(const multicopter_mpc_msgs::WholeBodyTrajectory::ConstPtr &msg) override;
 ...
 private:
  ...
  multicopter_mpc_msgs::WholeBodyTrajectory::ConstPtr msg_;
  bool is_info_;
...
#endif  // multicopter_mpc_rviz_WHOLE_BODY_STATE_DISPLAY_H