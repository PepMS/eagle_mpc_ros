 ...
 * @brief Displays a multicopter_mpc_msgs::WholeBodyState message
 */
class WholeBodyStateDisplay : public rviz::MessageFilterDisplay<multicopter_mpc_msgs::WholeBodyState> {
  Q_OBJECT
 public:
   ...
   * @param const multicopter_mpc_msgs::WholeBodyState::ConstPtr& Whole-body state msg
   */
  void processMessage(const multicopter_mpc_msgs::WholeBodyState::ConstPtr &msg) override;
 ...
 private:
  ...
  multicopter_mpc_msgs::WholeBodyState::ConstPtr msg_;
  bool is_info_;
